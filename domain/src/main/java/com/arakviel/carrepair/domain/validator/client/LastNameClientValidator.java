...
class LastNameClientValidator extends ClientValidator {

    LastNameClientValidator(Map<String, List<String>> validationMessages) {
    ...
    public boolean validate(Client client) {
        ...
        if (!errorMessages.isEmpty()) {
            validationMessages.put("lastName", errorMessages);
